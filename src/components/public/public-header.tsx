...
import { Database, Menu, X, Sun, Moon, User } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 border-b border-neutral-200/80 bg-white/70 backdrop-blur-xl dark:border-neutral-800/50 dark:bg-black/70">
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-8 px-4">
        <Link href="/" className="flex shrink-0 items-center gap-2.5">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg border border-neutral-200 bg-neutral-100 dark:border-neutral-800 dark:bg-neutral-900">
        ...
        <div className="ml-auto flex items-center gap-3">
          <SearchBar className="hidden w-64 sm:block lg:w-80" />
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-lg p-2 text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-white md:hidden"
          >
      ...
      {mobileOpen && (
        <div className="animate-fade-in border-t border-neutral-200/80 bg-white/95 px-4 pb-4 pt-2 backdrop-blur-xl dark:border-neutral-800/50 dark:bg-black/95 md:hidden">
