...
export default async function DatacentersPage() {
  const listings = await getPublicListingsByCategory("datacenter");
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-neutral-900 dark:text-white">Data Centers</h1>
            <p className="text-sm text-neutral-500">
              {listings.length} data {listings.length === 1 ? "center" : "centers"}
            </p>
          </div>
        </div>
      ...
      {listings.length > 0 ? (
        ...
        <div className="flex flex-col items-center gap-4 rounded-2xl border border-dashed border-neutral-200 dark:border-neutral-800 py-20">
          ...
          <div className="text-center">
            <p className="font-medium text-neutral-500 dark:text-neutral-400">No data centers yet</p>
